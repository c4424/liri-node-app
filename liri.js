...
var keys = require('./keys.js') // import the keys.js and then store it into a variable
var axios = require('axios'); // for omdb and bandsintown api
const moment = require('moment') // for use of moment.js
var Spotify = require('node-spotify-api'); // this is needed so the spotify api can work
